...
describe('Edge Cases E2E - Malformed Data', () => {
  let tempDir: string;
...
describe('Edge Cases E2E - Large Data Volumes', () => {
  let tempDir: string;
  let projectsDir: string;
  const originalEnv = process.env;
...
describe('Edge Cases E2E - Date and Time Handling', () => {
  let tempDir: string;
  let projectsDir: string;
  const originalEnv = process.env;
...
describe('Edge Cases E2E - Provider Failures', () => {
  let tempDir: string;
  const originalEnv = process.env;
...
describe('Edge Cases E2E - Sanitization Edge Cases', () => {
  const originalEnv = process.env;
...
describe('Edge Cases E2E - Concurrent Operations', () => {
  let tempDir: string;
  let projectsDir: string;
  const originalEnv = process.env;
