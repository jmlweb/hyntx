...
describe('Provider Integration - Provider Selection and Fallback', () => {
...
describe('Provider Integration - Ollama Provider', () => {
  const originalEnv = process.env;
...
describe('Provider Integration - Anthropic Provider', () => {
  const originalEnv = process.env;
...
describe('Provider Integration - Google Provider', () => {
  const originalEnv = process.env;
...
describe('Provider Integration - Provider Factory', () => {
  const originalEnv = process.env;
